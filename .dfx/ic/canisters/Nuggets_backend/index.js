...
import { idlFactory } from './Nuggets_backend.did.js';
export { idlFactory } from './Nuggets_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NUGGETS_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Nuggets_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Nuggets_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Nuggets_backend.did.js")._SERVICE>}
 */
export const Nuggets_backend = createActor(canisterId);
