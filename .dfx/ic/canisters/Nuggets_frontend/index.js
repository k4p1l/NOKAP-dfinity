...
import { idlFactory } from './Nuggets_frontend.did.js';
export { idlFactory } from './Nuggets_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NUGGETS_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Nuggets_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Nuggets_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Nuggets_frontend.did.js")._SERVICE>}
 */
export const Nuggets_frontend = createActor(canisterId);
